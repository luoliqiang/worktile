...
/***/ function(module, exports, __webpack_require__) {
	...
	var TaskWrappers = React.createClass({ displayName: "TaskWrappers",
	    render: function () {
	        return React.createElement("div", { className: "task-wrapper" }, React.createElement("p", { className: "task-title" }, "要ddddddd做"));
	    }
	});
	setTimeout(function () {
	    ReactDOM.render(React.createElement(TaskWrappers, null), document.getElementById('js-task-wrapper'));
	}, 3000);
