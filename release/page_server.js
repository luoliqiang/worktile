...
/***/ function(module, exports, __webpack_require__) {
	...
	var componont_task = function (datas) {
	    ...
	    var AddTask = React.createClass({ displayName: "AddTask",
	        addItem: function (event) {
	            ...
	            React.createElement("this", { class: "refs taskTextarea" }).focus();
	        },
	    ...
	    var TaskWrapper = React.createClass({ displayName: "TaskWrapper",
	        getInitialState: function () {
	            ...
	            if (typeof window !== 'undefined') {
	                userInfo = JSON.parse(window.initData);
	            } else {
	                userInfo = datas;
	            }
	            for (var i = 0; i < userInfo.length; i++) {
	                task_data_arr.push({ task_name: userInfo[i].task_name, task_id: userInfo[i].task_id });
	            }
	...
	if (typeof window !== 'undefined') {
	    ...
	    var TaskWrapper = componont_task();
	    ReactDOM.render(React.createElement(TaskWrapper, null), document.getElementById('js-task-wrapper'));
	} else {
	    module.exports = componont_task;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  ...
	  var ReactNativeOperationHistoryDevtool = __webpack_require__(23);
	  var ReactComponentTreeDevtool = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./poem2.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./poem2.css");
